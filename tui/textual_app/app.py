...
class HandsomeAgentApp(App):
    ...
    def _send_welcome_message(self) -> None:
        ...
        在 TUI 启动时，根据 workspace 配置（agent.md、memory.md 等）生成问候语，
        并显示在聊天区域。
        """
...
只返回问候语本身，不要其他内容。"""
    ...
    def _get_default_greeting(self) -> str:
        ...
        greetings = {
            "zh": ["你好！有什么我可以帮你的吗？", "嗨！准备好开始工作了吗？", "你好！很高兴见到你。"],
            "en": ["Hello! How can I help you today?", "Hi! Ready to get started?", "Hello! Nice to see you."],
            "ko": ["안녕하세요! 어떻게 도와드릴까요?", "안녕! 오늘도 좋은 하루 되세요.", "안녕하세요! 반갑습니다."],
            "ja": ["こんにちは！何かお手伝いできますか？", "こんにちは！始めましょうか？", "こんにちは！お会いできて嬉しいです。"],
        }
