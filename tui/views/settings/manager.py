...
class SettingsManager:
    ...
    def _load(self) -> None:
        ...
        self._settings = SettingsDocument.from_cli_config(cli_config)
    ...
    def save(self) -> bool:
        ...
        try:
            # 转换为 CLI 配置格式
            cli_config = self._settings.to_cli_config()
    ...
    def reset_to_defaults(self, category: Optional[str] = None) -> None:
        ...
        from tui.views.settings.models import (
            SettingsDocument, LLMConfig, ModelConfig, DisplayConfig,
            PreferencesConfig, SessionConfig, MemoryConfig, TerminalConfig,
            ToolConfig, LoggingConfig, AgentConfig, SessionResetConfig,
            CompressionConfig, IntentMode, TUI_DEFAULTS
        )
