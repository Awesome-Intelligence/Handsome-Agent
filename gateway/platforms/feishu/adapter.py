    ...
    if normalized_type in {"file", "audio", "media"}:
        ...
        return FeishuNormalizedMessage(
            ...
            preferred_message_type=(
                "audio" if normalized_type == "audio" else "document"
            ),
...
class FeishuAdapter(BasePlatformAdapter):
    ...
    def _on_drive_comment_event(self, data: Any) -> None:
        ...
        """
        from gateway.platforms.feishu.feishu_comment import handle_drive_comment_event
    ...
    def _on_meeting_invited_event(self, data: Any) -> None:
        ...
        from gateway.platforms.feishu.feishu_meeting_invite import (
    ...
    def _submit_on_loop(self, loop: Any, coro: Any) -> bool:
        ...
        from gateway.platforms._hermes_stubs import safe_schedule_threadsafe
    ...
    def _resolve_channel_prompt(
        self, chat_id: str, parent_id: str | None = None
    ) -> str | None:
    ...
    def _admit(self, sender: Any, message: Any) -> Optional[RejectReason]:
        ...
        if not is_group:
            if os.getenv("FEISHU_ALLOW_ALL_USERS", "").strip().lower() in {
                "true",
                "1",
                "yes",
            }:
...
def register() -> None:
    """Register the Feishu platform with the Agent-Z gateway registry."""
    ...
    platform_registry.register(
        PlatformEntry(
            ...
            install_hint="pip install 'lark-oapi' aiohttp websockets",
