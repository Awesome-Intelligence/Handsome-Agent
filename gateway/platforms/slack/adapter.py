...
def check_slack_requirements() -> bool:
    ...
    from gateway.platforms._hermes_stubs import ensure_and_bind
...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            ...
            from gateway.platforms._hermes_stubs import slack_native_slashes
            import re as _re
            ...
            try:
                from gateway.platforms._hermes_stubs import get_plugin_manager
        ...
        if callable(auth_fn):
            try:
                ...
                source = SessionSource(
                    ...
                    chat_type=(
                        "dm" if str(channel_id or "").startswith("D") else "group"
                    ),
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        if slash_name in {"hermes", ""}:
            ...
            from gateway.platforms._hermes_stubs import slack_subcommand_map
...
def interactive_setup() -> None:
    ...
    def _write_slack_manifest_and_instruct() -> None:
        ...
        try:
            from gateway.platforms._hermes_stubs import _build_full_manifest
            from gateway.platforms._hermes_stubs import get_hermes_home
            import json as _json
