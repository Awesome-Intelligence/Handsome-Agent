...
try:
    ...
    Exception
):  # noqa: BLE001 — broad: optional SDK's transitive deps (cryptography) may raise non-ImportError; degrade gracefully (#41112)
...
def check_dingtalk_requirements() -> bool:
    ...
    if not DINGTALK_STREAM_AVAILABLE or not HTTPX_AVAILABLE:
        # tools.lazy_deps stubbed - lazy install not available in Agent-Z
        try:
...
async def _standalone_send(
    ...
    *,
    ...
    try:
        ...
        try:
            from gateway.platforms._hermes_stubs import _error as _redact_error
...
def interactive_setup() -> None:
    ...
    from gateway.platforms._hermes_stubs import prompt_choice
    ...
    if method == 0:
        try:
            from gateway.platforms._hermes_stubs import dingtalk_qr_auth
...
def register() -> None:
    """Register the DingTalk platform with the Agent-Z gateway registry."""
