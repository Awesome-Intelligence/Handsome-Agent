...
class TeamsSummaryWriter:
    ...
    def _build_graph_client(self, config: dict[str, Any]) -> Any:
        ...
        from gateway.platforms._hermes_stubs import MicrosoftGraphTokenProvider
        from gateway.platforms._hermes_stubs import MicrosoftGraphClient
...
def interactive_setup() -> None:
    ...
    if prompt_yes_no("Restrict access to specific users? (recommended)", True):
        ...
        print_warning(
            "⚠️  Open access — anyone who can message the bot can command it."
        )
