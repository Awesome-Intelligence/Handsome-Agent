...
from gateway.platforms._hermes_stubs import Colors, color
...
def _autoconfigure_access(phone: str) -> None:
    ...
    """
    try:
        from gateway.platforms._hermes_stubs import get_env_value, save_env_value
    except ImportError:
        return
    for key, label in (
...
def _cmd_telemetry(args: argparse.Namespace) -> int:
    ...
    if state is None:
        ...
        return 0
    try:
        from gateway.platforms._hermes_stubs import save_env_value
