...
在整个 Agent 循环中共享状态，用于传递任务信息、工具定义和对话历史。
...
class ExecutionContext:
    ...
    def __init__(
        ...
        **kwargs
        ...
        # 初始化 _messages，从 conversation_history 合并历史消息（保留完整信息）
...
__all__ = ["ExecutionContext", "ToolDefinition", "Message", "ToolCallRecord", "ToolCallInfo"]